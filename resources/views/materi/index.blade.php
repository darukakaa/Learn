                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-gray-900">
                            ...
                            <p class="text-sm text-gray-600">
                                Role: {{ auth()->user()->role ?? 'No role found' }}
                            </p>

                            <!-- Only show the "Add Materi" button to admin and guru roles -->
                            @if(auth()->user()->role == '0' || auth()->user()->role == '1')
                                <a href="{{ route('materi.create') }}" class="bg-blue-500 hover:bg-blue-700 text-black font-bold py-2 px-4 rounded inline-block mb-4">Add Materi</a>
                            @endif

                                    ...
                                    <table class="table-auto w-full border">
                                        ...
                                        <script>
                                            function openModal(id, nilai = '') {
                                                ...
                                                modal.classList.add('flex'); // ⬅️ tambahkan baris ini
                                            ...
                                            function closeModal() {
                                                ...
                                                modal.classList.remove('flex'); // ⬅️ hapus class flex saat ditutup
                                            }
                                        </script>
                                    </table>
                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div class="bg-customold shadow-sm rounded-lg mb-4 border border-gray-300 px-4 py-3 -mt-10">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-left">
                                <h1 class="text-4xl font-bold">{{ $learning->name }}</h1>
                                <p class="mt-2 text-2xl font-semibold">Tahap 4 Pengembangan dan Penyajian</p>
                    ...
                    <script>
                        document.addEventListener("DOMContentLoaded", function() {
                            let target = {{ $progress }}; // nilai progress dikirim dari controller

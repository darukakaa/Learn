<x-app-layout>
    ...
    @if (auth()->user()->role == '2')
                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="bg-customold shadow-sm rounded-lg mb-4 border border-gray-300 px-4 py-3 -mt-10">
                        <div class="text-center">
                            ...
                            <div class="flex justify-center mt-3 space-x-2">
                                <a href="{{ route('learning.index') }}"
                                    class="btn btn-secondary inline-block px-3 py-1 text-sm">Kembali ke Daftar
                                    Learning</a>
                                <a href="{{ route('learning.stage', ['learningId' => $learning->id, 'stageId' => 2]) }}"
                                    class="btn btn-secondary inline-block px-3 py-1 text-sm">Kembali ke Tahap 2</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white shadow-sm sm:rounded-lg mb-6">
                        <div class="p-6 bg-customold border-b border-gray-200">
                            ...
                            <button type="button" data-bs-toggle="modal" data-bs-target="#modalCatatan"
                                class="btn btn-primary">Tambahkan Catatan</button>
                                            ...
                                            <td class="px-4 py-2 border">
                                                @if (!$catatan->is_validated)
                                                    <button type="button" class="btn btn-sm btn-warning"
                                                        ...
                                                        data-bs-target="#editModal{{ $catatan->id }}">Edit</button>
                                                @else
                            ...
                            @if (auth()->user()->role == 2 && $isValidated)
                                <a href="{{ route('learning.stage4', ['id' => $learning->id]) }}"
                                    class="btn btn-primary rounded-full mt-4">Lanjut ke Tahap 4</a>
                            @endif
                        </div>
                    </div>
                </div>
        ...
        <!-- Modal Tambah Catatan (dipindah ke luar main-content) -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="{{ route('catatan.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="mb-4">
                                <label for="isi_catatan" class="block font-medium mb-1">Isi Catatan</label>
                                <textarea name="isi_catatan" id="isi_catatan" rows="4" class="w-full border rounded px-3 py-2" required></textarea>
                            </div>
                            <div class="mb-4">
                                <label for="file_catatan" class="block font-medium mb-1">Upload File
                                    (Opsional)</label>
